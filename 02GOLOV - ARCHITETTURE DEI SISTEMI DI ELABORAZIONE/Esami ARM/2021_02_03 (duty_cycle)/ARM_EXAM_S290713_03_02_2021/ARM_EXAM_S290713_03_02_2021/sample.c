...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(1, 50000000); // usato per far alternare i LED
	init_timer(2, 625000); // timer utilizzato per campionare il segnale del joystick
	init_timer(3, 25000000); // usato per la modalità Acquisizione
