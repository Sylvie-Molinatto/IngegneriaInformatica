...
CRP_Key         DCD     0xFFFFFFFF
                ...
                AREA result, DATA, READWRITE, ALIGN=2
...
svc2            LDR R0, =_Matrix_Coordinates
				LDR R1, =Opt_M_Coordinates
				MOV r2, #0 ;i
				MOV r3, #0 ;j
				
ciclo			LDRB r5, [r0, r2, lsl #2]
                STRB r5, [r1, r3]
				add r2,r2,#1
				add r3,r3,#1
				cmp r2,#ELEMENTS
...
__user_initial_stackheap
                ...
                LDR     R0, =  Heap_Mem
                LDR     R1, = Stack_Mem; Stack_Size/2)
                LDR     R2, = (Heap_Mem +  Heap_Size)
                LDR     R3, = (Stack_Mem + Stack_Size/2)
                BX      LR
