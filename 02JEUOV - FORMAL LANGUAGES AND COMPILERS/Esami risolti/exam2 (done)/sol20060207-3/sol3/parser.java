...
public class parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short _production_table[][] = 
    ...
    "\003\000\002\003\011\000\002\004\003\000\002\004\004" +
    "\000\002\006\005\000\002\005\005\000\002\013\004\000" +
    "\002\007\003\000\002\007\006\000\002\015\002\000\002" +
    "\010\010\000\002\010\010\000\002\011\002\000\002\011" +
    "\004\000\002\012\006\000\002\014\003\000\002\016\003" +
    "\000\002\016\005" });
  ...
  protected static final short[][] _action_table = 
    ...
    "\002\000\006\006\ufffd\020\ufffd\001\002\000\004\005\057" +
    "\001\002\000\004\016\047\001\002\000\006\006\016\020" +
    "\012\001\002\000\006\006\ufffc\020\ufffc\001\002\000\004" +
    "\013\017\001\002\000\006\007\022\010\021\001\002\000" +
    "\006\002\ufff3\017\ufff3\001\002\000\004\013\030\001\002" +
    "\000\004\013\023\001\002\000\004\014\024\001\002\000" +
    "\004\010\025\001\002\000\004\013\026\001\002\000\004" +
    "\015\027\001\002\000\006\002\ufff5\017\ufff5\001\002\000" +
    "\004\015\031\001\002\000\004\007\032\001\002\000\004" +
    "\013\033\001\002\000\004\014\034\001\002\000\006\002" +
    "\ufff4\017\ufff4\001\002\000\006\002\ufffe\017\040\001\002" +
    "\000\006\002\ufff2\017\ufff2\001\002\000\004\013\041\001" +
    "\002\000\004\013\ufff0\001\002\000\004\016\042\001\002" +
    "\000\006\011\uffef\012\uffef\001\002\000\006\011\045\012" +
    "\044\001\002\000\004\016\046\001\002\000\006\002\ufff1" +
    "\017\ufff1\001\002\000\006\011\uffee\012\uffee\001\002\000" +
    "\004\020\056\001\002\000\006\011\053\012\052\001\002" +
    "\000\006\011\ufff8\012\ufff8\001\002\000\004\016\ufff6\001" +
    "\002\000\006\006\ufffb\020\ufffb\001\002\000\004\016\047" +
    "\001\002\000\006\011\ufff7\012\ufff7\001\002\000\006\011" +
    "\ufff9\012\ufff9\001\002\000\004\013\060\001\002\000\004" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\057\000\006\002\004\003\005\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\010\004\013\005\012\006\010\001\001\000\002\001" +
    "\001\000\002\001\001\000\006\007\047\013\050\001\001" +
    "\000\006\005\012\006\014\001\001\000\002\001\001\000" +
    "\002\001\001\000\004\010\017\001\001\000\004\011\034" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\002\001\001\000\002\001\001\000\002\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\006" +
    "\012\035\014\036\001\001\000\002\001\001\000\002\001" +
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
		...
		RESULT = start_val;
		 ...
		 parser.report_error("Error in file\n",null); 
          ...
          case 3: // prog_ok ::= START C mp3_list SERVER C data_time user_list 
            { parser.Tree.reduce(7,"prog_ok",1);
              Object RESULT =null;

              CUP$parser$result = parser.getSymbolFactory().newSymbol("prog_ok",1, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-6)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // mp3 ::= dim song_list S 
            { parser.Tree.reduce(3,"mp3",0);
              Object RESULT =null;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // dim ::= NUMBER KBS C 
            { parser.Tree.reduce(3,"dim",0);
              Object RESULT =null;
     ...
     parser.symbol_table.put(title, length*rate); 
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("song",9, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // song_list ::= song_list CM NT0 song 
   ...
   System.out.println("TOTAL: " + x);
		...
		String ip = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 System.out.println(ip); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("ip",10, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
   ...
   RESULT = length;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("songs_list",12, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
   ...
   RESULT = length + x;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("songs_list",12, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
