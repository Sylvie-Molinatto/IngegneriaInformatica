...
public class SparkDriver {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		JavaPairDStream<Integer, String> countsHashtagsSorted = hashtagsCounts
		...
		countsHashtagsSorted.print();
		
	    // Store the output of the computation in the folder with prefix outputPrefix
		countsHashtagsSorted.dstream().saveAsTextFiles(outputPathPrefix, "");
